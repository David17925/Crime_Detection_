...
class DeepSort(object):
    ...
    def update(self, bbox_xywh, confidences, oids, ori_img):
        ...
        if bbox_xywh.shape[0] == 0:
            # Aucune détection, renvoyer une sortie vide
            return np.empty((0, 6), dtype=np.int)
    ...
    def _xywh_to_tlwh(bbox_xywh):
        ...
        print("bbox_xywh shape:", bbox_xywh.shape)  # Ajoutez cette ligne
        ...
        print("bbox_tlwh shape:", bbox_tlwh.shape)  # Ajoutez cette ligne
